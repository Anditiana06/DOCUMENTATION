...
-- Procedures
--
CREATE DEFINER=`anditiana`@`%` PROCEDURE `GetClientsByCarBrand` (IN `carBrand` VARCHAR(50))   BEGIN
    SELECT c.*
FROM client c
...
(1, 'Andi', 'admin', 'admin', 1),
(2, 'admin1', 'admin1', 'admin1*1234', 1);
...
(16, 'Rzf', 'Andi', 57846927, 'Rose-hill', 'anditiana.rzf@gmail.com', 'Azertyuiop1234*'),
(17, 'Client', 'Client', 57894521, 'Curepipe', 'client@gmail.com', 'Qwertyuiop1234*');
...
(47, 'Bonjour', '2023-12-15 14:05:26', 16),
(48, 'Test ', '2023-12-15 14:05:38', 16);
...
(6, 16, '2023-12-10 12:56:35'),
(7, 17, '2023-12-10 13:37:54');
